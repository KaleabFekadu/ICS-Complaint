                        ...
                        Obx(() => Column(
                          ...
                          children: [
                            ...
                            if (controller.firstNameError.isNotEmpty)
                              Text(
                                controller.firstNameError.value.tr, // Localized
                        ...
                        Obx(() => Column(
                          ...
                          children: [
                            ...
                            if (controller.passwordError.isNotEmpty)
                              Text(
                                controller.passwordError.value.tr, // Localized
                                style: const TextStyle(
                                    color: Colors.red, fontSize: 12),
                              ),
                            const SizedBox(height: 10),
                        ...
                        Obx(() => Column(
                          ...
                          children: [
                            TextField(
                              ...
                              decoration: InputDecoration(
                                labelText: 'Confirm Password'.tr, // Localized
                                filled: true,
                                fillColor: Colors.white,
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),
                            ...
                            if (controller.confirmPasswordError.isNotEmpty)
                              Text(
                                controller.confirmPasswordError.value.tr, // Localized
                                style: const TextStyle(
                                    color: Colors.red, fontSize: 12),
                              ),
                            const SizedBox(height: 10),
